...
export default function Details() {
  ...
  return (
    <>
      ...
      <div className='overflow-y-auto mobile-chart h-full'>

        <div className='mobile-detail flex justify-between mx-[400px]'>
          <div className=' mt-5 mobile-cover'>
            <div className='mobile-text-header text-center rounded-t-md font-extrabold bg-green-600 text-white'>Total infected</div>
          ...
          <div className=' mt-5 mobile-cover'>
            <div className='mobile-text-header  text-center rounded-t-md font-extrabold bg-red-600 text-white'>Total Death</div>
            <div className='shadow-xl w-[200px] px-6 py-4 bg-white rounded-md '>
              <ul>
          ...
          <div className=' mt-5 mobile-cover'>
            <div className='mobile-text-header  text-center rounded-t-md font-extrabold bg-blue-600 text-white'>Total recovery</div>
            <div className='shadow-xl w-[200px] px-6 py-4 bg-white rounded-md '>
              <ul className=''>
