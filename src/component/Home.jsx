...
export default function Home() {
    ...
    return (
        <>
            ...
            {status === 'pending' ? <div className='grid h-screen place-items-center'><img src="Color Fill Loading Image Gif.gif" className='w-[500px] h-[400px]' alt="loading" /></div> : <div className='flex gap-[100px] px-[100px] py-[30px] mobile-flex'>

                <div className='mobile-cont mt-5'>
                    <div className='mobile-cont-heder text-center rounded-t-md font-extrabold bg-black text-white'>Filter by Continent</div>
                    ...
                    <table className="table-auto mt-5 shadow-2xl bg-white">
                        <thead>
                            <tr className='bg-black text-white'>
                                <th className='bold'><div className='mobile-table-head flex'>No.</div></th>
                                <th className='bold'> <div className='flex mobile-table-head'><img src='/icons8-descending-sorting-50.png' height="15px" width="25px"></img> Continent </div></th>
                                <th className='bold'><div className='flex mobile-table-head' onClick={() => handelFilter()} ><img src='/icons8-descending-sorting-50.png' height="15px" width="25px"></img> Country </div></th>
                                <th className='bold pl-[10px]'><div className='flex mobile-table-head' onClick={() => handelPopulation()} ><img src='/icons8-descending-sorting-50.png' height="15px" width="25px"></img> Population </div></th>
                                <th className='bold pl-[10px]'><div className='flex mobile-table-head' onClick={() => handelCase()} ><img src='/icons8-descending-sorting-50.png' height="15px" width="25px"></img> Total Case </div></th>
